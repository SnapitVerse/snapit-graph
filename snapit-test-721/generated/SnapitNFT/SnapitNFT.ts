...
export class SnapitNFT__royaltyInfoResult {
  value0: Address;
  value1: BigInt;
...
export class SnapitNFT extends ethereum.SmartContract {
  ...
  royaltyInfo(
    ...
    return new SnapitNFT__royaltyInfoResult(
      result[0].toAddress(),
      result[1].toBigInt(),
    );
  }
  ...
  try_royaltyInfo(
    tokenId: BigInt,
    salePrice: BigInt,
  ): ethereum.CallResult<SnapitNFT__royaltyInfoResult> {
    let result = super.tryCall(
      "royaltyInfo",
      "royaltyInfo(uint256,uint256):(address,uint256)",
      [
    ...
    return ethereum.CallResult.fromValue(
      new SnapitNFT__royaltyInfoResult(
        value[0].toAddress(),
        value[1].toBigInt(),
      ),
    );
